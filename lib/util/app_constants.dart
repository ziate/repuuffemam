...
class AppConstants {
  ...
  static const String USED_MARKET_PRODUCTS_URI =
      'https://repuffapp.com/api/v1/vendor/used-market';
  ...
  static final decorationSignUpScreen = OutlineInputBorder(
    borderRadius: BorderRadius.circular(Dimensions.RADIUS_EXTRA_LARGE),
    borderSide: BorderSide(width: 1, color: Color(0xFF0F4F80)),
  );
  static final decorationSignInScreen = OutlineInputBorder(
    borderRadius: BorderRadius.circular(Dimensions.RADIUS_EXTRA_LARGE),
