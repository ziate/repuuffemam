              ...
              Padding(
                ...
                child: Column(
                    ...
                    children: [
                                      ...
                                      : GetBuilder<WishListController>(
                                          ...
                                          return InkWell(
                                            ...
                                            child: Icon(
                                              ...
                                              color: wishList.wishProductIdList
                                                      .contains(
                                                          widget.product.id)
                                                  ? Colors.white
                                                  : kTextColor,
                      ...
                      Row(children: [
                        Text('quantity'.tr,
                            style: robotoMedium.copyWith(color: kTextColor)),
                      ...
                      Row(children: [
                        ...
                        Text(PriceConverter.convertPrice(priceWithAddons),
                            style: robotoBold.copyWith(color: kTextColor)),
                      ]),
                      SizedBox(height: Dimensions.PADDING_SIZE_LARGE),
                                ...
                                style: ElevatedButton.styleFrom(
                                  ...
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(
                                        Dimensions.RADIUS_SMALL),
                                    side:
                                        BorderSide(width: 2, color: kIconColor),
                                  ),
                                ),
                                onPressed: () {
                                  if (widget.inRestaurantPage) {
                                    ...
                                    Get.offNamed(RouteHelper.getRestaurantRoute(
                                        widget.product.restaurantId));
                                  }
                                },
                                child: Image.asset(Images.house,
                                    color: kIconColor, height: 30, width: 30),
                              ),
